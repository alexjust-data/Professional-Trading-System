...
y tiene una de un 40% no perdón no 40 46 46 es justo es pobre acuerdo es pobre si hubiéramos hecho 20 y 20 por ejemplo sería mejor bien ahí estaríamos más razonable pero 20 por ciento anualizado con 45 de no darles es demasiado para mí no sería suficiente no sería suficiente pero bueno la idea y adiós la idea inicial la idea inicial de entrada de don chan es totalmente válida donde por ejemplo este sistema incluso así iría probablemente mejores en materias primas seguramente oro petróleo puede ser que fuera soja cosas así pues así podría ser que fuera que fuera bien pero de otras maneras insisto que aún así creo que le plantearía algún cambio le plantearía un cambio para mejorar bien de los que hemos hecho para que veáis en el caso que quisiéramos quedarnos con uno como ejemplo hemos empezado por este hoy vale y aquí que miramos bueno aquí miramos poco curvas drawdown ratos de retorno riesgo cual nos dan al final aquí de los que no hemos visto aquí sólo tenemos sharp en este caso diario y rr 087 y aquí tenemos el r anual y el char sigue siendo diario no se ha anualizado pero vamos a publicar nosotros 0 0 75 por raíz de lo fácil 370 da 109 109 yéndolo ya por por por 360 da 109 es realmente justo fijaros aquí un 80 por ejemplo aquí tenemos un 80 igual 2 19 1 92 este 1 24 02 por sorpresa era el sortino ya lo sospechaba que ya por ahí la cosa es el que sale con mejor es verdad y también mejor usar en este caso pero 0603 a mí me gusta mucho el sortino yo os lo dije y veis que por raíz de 360 pues mejoran un poquito pero 1 14 sería 1 1 14 sharp anualizado 2 19 de triple r 23 71 de compuesto y aquí con un drawdown de 44 76 bajado un par de puntos pero bueno sigue siendo un drawdown demasiado demasiado alto y aún así aquí otro otro línea de mejora la línea de mejora importante y ligo otra vez con las consultas que me había hecho antes aureli sería un poco y decir esto al final simplemente le hemos hecho como decía para validar la estrategia yo en el caso como lo planteara operar que haríamos otro tipo otro tipo de análisis y miraríamos reduciríamos reduciríamos la cesta reduciríamos la cesta sales más lecciones por ejemplo lo que hemos hablado antes un criterio por supuesto de rendimiento sería sería válido otro no menor de histórico es decir donde podamos mirar más que ha hecho esa acción porque aquí no todas las acciones tienen el mismo histórico de acuerdo este es un problema aquí no tenemos tampoco sesgo de supervivencia aquí abajo nos ha hecho la tv student ya va a hacer el programa automática en la mayoría aunque va a haber salido alguno que no la mayoría ves que te da que sí que si tienes alguno que no seguramente pere dinero y saber algunos que tienen perdido dinero otros que ven entonces yo aquí puedo analizar y puedo ver todas las acciones que me gusta el maestro que tengo cien repito puedo ver un poco pues dónde están aquellas las puedo apuntar y puedo tratar de hacerme alguna alguna cesta y ver en esas un poco como ha ido pero pero bastante se recordarán acciones lo que os dije aquí el riesgo de gap es enorme el riesgo de gap es enorme que hace el 10% entonces hay que ir a una exposición muy muy baja de acuerdo porque tú has expuesto un 2 y te meten un 10 te has metido un 20 y estás expuesto un 2 es poco entonces este es el problema por eso tenemos también tanto de lo que te han cazado muchas en algunos momentos han cazado muchas y te las tragas y además cuando hay caídas de mercado globales te las tragas todas claro y te meten un gap y te cosiste el problema de este tipo de estrategias en acciones que cuesta mucho de controlar riesgo con estrategia o sea con sobre optimización es fácil pero en la realidad con estrategias como esta que no están sobre optimizadas porque están miradas en cien acciones no es fácil pero así fíjate aureli tienes aquí está que digamos ratio de profit factor por ponerlo fácil no que si no nos vamos a hacer un poco trampas viendo un poco el valor de cada uno profit factor aquí mira esto tenemos 259 pero cuando estrés tiene y estrés no van a tener mucho las que más van a tener van a tener 20 algo más bueno pues tienes aquí unas cuantas que pueden estar ahí en el ratio de profit factor de 2 que a lo mejor pues merecen una mayor 11 estos demasiado seguramente como si no muchos a bueno es envidia claro miras un cohete claro lógicamente las más volátiles se ayudarán más que hemos metido de todo y eso mejoraría mucho la cartera y esto ya digo son deberes que los dejo a vosotros con esta simple estrategia y ahora probarlo en distintas acciones no me puedo usarlo maestro pasa nada tú coge el programa que tengas el mismo código lo vas cargando aquí para una acción a la otra todos los programas tienen este mecanismo de la tabla al lado y lo vas probando a ver o sea he visto ahí envidia me han dicho que la ver en aquí las tengo ordenadas por market cap quiere decir que envidia está por aquí qué pasa que envidiamos como es un misil vamos a poner este mismo set y lógicamente si tú encuentras una cesta de 20 acciones 20 acciones que está por defecto con 20 con 20 024 creo que el que teníamos aquí era 24 022 y 4 022 y con el filtro activado en uno aquí tenemos que lógicamente envidia es un misil envidia ha sido un misil dices hombre en esa estrategia va bien pero bueno no digo que no siga yendo igual de bien de verdad puede ser la estrategia repito esta validad en todas y por lo tanto se ha analizado en todas o sea puede ser que siga yendo bien perfecto pero hay que tener en cuenta que una estrategia en acciones ligo un poco con lo que pregunta y aureli de cómo recomiendo el rebajar el drama sobre todo sobre todo con diversificación porque al final o sea el problema de los sistemas tendenciales puros es este es decir si tú tienes un tendencial puro insisto insisto aureli que es demasiado más de 40 pero pero es igual en pongo lo bajar a los 10 puntos porque tal vez tampoco te pido bajarlo al 20 vale una tendencia al pura sabrá tendencia al pura que es capaz de ganar esto esta locura sobre hablar fuertes porque para ganar esto también te has tragado alguna acción que no entonces al final ese es el problema pues ahí lo hemos validado en todas y conseguimos que tengamos algo muy fuerte y tú ahora podrías podrías aplicarlo a lo mejor a 10 acciones que ya te he dicho que no cogería las 10 como esta perdón 20 20 al menos no cogería las 20 como estas pero a lo mejor 10 sí que cogería donde ha ido muy bien y tenga bastante histórico cuidado pero lo que hemos cogería algunas que a lo mejor pues no tanto por lo que fuera a lo mejor porque está lateral ese activo pero bueno no tiene por qué estarlo siempre mejor ahora envidia de pronto se acaba esto y no sube nunca más es que al final el problema el problema es que no conocemos el futuro envidia ahora va muy bien ya ya ya no sé qué va a hacer pero irá siempre así no sé a lo mejor de pronto no sé tesla de pronto su software de coches que dicen que es el mejor de auto se ponen todos de moda decide que todas mangas que es que 4 es una mierda se lo voy a comprar a tesla y tesla automáticamente empieza a vender software a todas las marcas de coches esto me lo he inventado totalmente pero me entendéis entonces este es el módulo 5 del curso latin de trading pero si el mercado no lo es simplemente no lo es bueno las acciones de este tipo de nuevas ideas que quiero decir que ya no y veo que el contrato es de los meses que ya nada es espectacular y los años sin hacer nada ahora se lo hubiera escogido en el 19 a 15 pues claro está a 200 sin hacer nada lleva y es a 200 habías podido comprar a 5 no hace tantos años entiendes decir al final bueno es este tipo de cosas caro ese tipo de cosas las coges con este tipo de acciones pero vamos a estar en el lado corto la has cogido tesla no al lado corto con el doncha pero pero este es el tema entonces aquí la diversificación sobre la mejor manera es con una cartera con porfolio a nivel de control de sistema es lo que te digo esto lo expliqué y alguien creo que en el foro en él en él en el chat ya hubiera en el disc or lo comentó no sé si fue en el disc or lo de que en él el profit target de mejorar a las mejoras a las salidas no que era contraintuitivo algo así bueno no recuerda bueno las salidas sal el tp es una cosa que mejora más el riesgo de lo que parece mejora mucho el módulo 6 el cura en un tenencial no hay tp entonces sólo lo puede ser donde veremos y tú vas a tener que apurar a todo tipo de órdenes también cosas que muchos términos en inglés es importante que nos quedemos con estos términos y he pensado en hacer porque no vamos a decir es algo que es muy importante porque además se aprende que se aprende más al error del texto que del acierto y en el curso pues yo también lo planteado así de acuerdo de cómo se aprende más del error pues aquí los señal cosas que no son perfectas de acuerdo porque es la parte uno de aprender es más de ellas latín de trading que de que ellos enseñen que bien va esto que va bien baquero largo contra corto y las probabilidades la curva del disco a error de programación vale bueno a ver a decir que no es replicable no es verdad eso básico para comenzar en tres compran la identidad venden fortaleza tomando en cuenta la tendencia esto creo que es uno de los mejores que el establo el micro lo cuentas y uno de los mejores conceptos para entender este concepto fundamental necesitamos el error de programación en tres es muy complicado que ya lo hemos venido pero acabamos entonces en tendencias alcistas tal y como vimos conviene ir largo es decir como el micro la acción y en tendencias bajistas conviene ir corto o vender la acción la tendencia más fuerte es la que tenga mayor es decir una temporalidad de un minuto y el error viene de los siguientes y usted buscando un sistema en el que digamos me haga me haga un break even y justo en los pares del yen me falla el porcentaje de recorrido que tiene que hacer para que entre en break even y me entra en break even prácticamente al inmediato y cuál es mi sorpresa cuando paso por los pares del yen veo esta maravilla de curva que no solo sucede en esta en muchos otros pares entonces ahora lo estoy intentando validar en mt4 porque claro aquí que haga muy poquito recorrido y ponga break even nos esto hace que pues nunca haya porque sólo quedan las buenas lo que pasa es que la entrada del sistema no es casi nunca coincide con la entrada teórica que te plantas en el trade station ya sea en el open next buy next bar o bien on close entonces esto cuando lo intentas replicar en la vida real lo estoy intentando hacer en mt4 no consigues no consigues esto si tenéis la solución de un error de back test más bien no sería error de bueno no porque realmente si tú miras la curva o sea mira esas operaciones que hace trade station y son correctas pero luego en la vida real esas operaciones no se pueden ejecutar o sea nunca se ejecutan ese precio porque en la apertura en forex al día es en daily además la apertura del día siguiente suele haber unos deslizamientos unas rupturas que dan miedo claro pero eso es por el tema de spread claro o sea porque en forex tienes bt ask y no tienes el last entonces ahí en trade station no estás back testando contra el last no lo sabes back testando contra el bt el ask exacto en la vida real pero no puedes o sea yo no sé cómo se pueda o no es un error de back test o sea cuando te quiero decir un error de programación es que estás haciendo algo que no es que no puedes hacer es decir estás leyendo a futuro el error de back test es que no estás consiguiendo si no estás consiguiendo replicar la realidad que es justo lo que dices tú no estás consiguiendo replicar la realidad de lo que pasa en el back test así es vale vale si queda queda entendido queda entendido bueno ahora profundizo un poco más te cierro el micro gracias aureli muchas gracias has debutado es el primero que hable si bueno lo que comenta en el forex claro entre este son que por cierto aurelín multicharts permite hacer eso vale te lo digo porque eso tres station no lo permite bueno no lo permite no lo permite en el sentido de dos datas y puedes penalizar con slip page el hecho que también podrías hacerlo así pero es bastante más real te lo voy a mostrar a que lo ha cerrado multichart lo abro un momento te lo voy a mostrar porque multichart si lo permite multichart si lo permite y creo que te puede venir bien esta característica a ver si me acuerdo rápido donde estaba pero creo que te lo podré enseñar o sea tres station a nivel de back test tú vienes aquí al sistema recuerda mal properties exactamente si un soporte aquí en el modo de back test se ve bien este dice back testing mode classic que es back testear lo en la serie de datos donde está metido o extendido que es back test se abre en el beat y el asiento tú le dices que para as usa esta serie de datos y para beat usa otra que lógicamente también tienes que tener metida en el gráfico entonces tú le puedes meter la serie del beat la serie de las que puede ser importada puede ser de otro vendor y back testearlo así back testearlo con as bit y eso será bastante más real eso será bastante más real porque eso te pasa porque la ventaja es estrecha cuando la ventaja es estrecha claro importa importa mucho el bricky ven de todas maneras tiene tendencia a tener problemas de este de este tipo porque el bricky ven al uso que se activa a partir de una cierta cantidad muchas veces nos pasa eso que nos ejecuta muy rápido y ahí por un lado tienes que ir a lo que hablábamos antes del lift de acuerdo tener muy claro cómo abre y tener muy claro el slipage a lo mejor tienes que penalizar con muchos slipage si no es reproducible pero de todas maneras el camino más cercano a probarlo va a ser probar esto que te he dicho multicharts si poniendo que tengas multicharts que ahora no lo sé claro si tienes multicharts si tienes multicharts te recomiendo probar esto a probar no no tienes multicharts vale entre station sí que tienes no puedes directamente hacerlo pero podrías hacerlo directamente podríamos o sea podrías montarte tú pero no con datos del sino con datos porque ahora no aunque sí que estaban no alberto los datos de antes estaban o que no sé si ahora están está el vídeo las que entre este son de divisas desde estaba no era euros punto no punto era punto ahí lo tiene ese señor sí que está entonces te puedes meter el ask y el beat en un dato recuerda que sólo puedes operar en el data uno sólo puedes operar en el data uno pero puedes consultar puedes preguntar al puedes preguntar a las veces yo tengo aquí arriba bueno vamos a pasar lo de gario no es ahora arriba tengo el beat el as que abajo tengo el beat es que está 93 está 90 y yo siempre voy a tirar la orden al beat pero como puedo consultar perdón perdón en este en este ejemplo que te estoy mostrando voy a tirar la orden al ask que sé que está arriba pero yo puedo puedo consultar el data 2 acuerdo que es el beat en el data 1 tengo las que en el data 2 tengo el beat ahora mismo como puedo consultar uno u otro pues puedo puedo jugar un poco con eso y ver más cerca de la realidad no sé si me estoy explicando que yo ejecuto arriba puedo hacerlo con una regla que dependa del de abajo entonces penalizar en base a eso mejor no puedes hacer un balance un poco mejor así recomiendo explorar esta esta opción porque al final el problema aquí es este no que en el forex aunque las plataformas de futuros y lo pintan porque va así donde está la matrix en realidad en realidad en el forex no hay aunque sí que hay no hay las como tal entiende la idea que ellos que no estoy familiarizados aprovecho para introducir este este concepto está el as que está el beat es que es este spread aquí está pintado ahora el euro a que se es el as que en realidad pero si ahora pinto aquí el euro dólar que va a ser mejor es el que es primario pues ves aquí yo tengo que está el último cruce a 97 pero ves aquí está el as que está a 802 7802 y el beat lo tengo a 7992 entonces yo si compro a mercado lo que hago es atacar el as y si vendo a mercado lo que hago es atacar el beat y entonces bueno como puedo pintar los dos en un gráfico pues puedo tratar de mejorar el backtest con eso exploró un poco ese camino si si comenta fran pregunta que si quiere hacerlo meta trader se puede considerar un spread más elevado para que compensa el spread de slipage y si el problema el el problema real del spread fran de este problema en el fondo no es tanto de reproducir el slipage porque eso es fácil sino de ejecutar la realidad porque si yo yo el de arriba es el as y el de abajo es el beat vale es decir el de arriba para que me entendáis pinta el rojo el de arriba pinta la columna roja vamos a hacerlo así para para no hasta para mí porque me equivoco continuamente como yo no estoy muy acostumbrado a operar pero si operamos los dps pero pero automáticamente sabes no no tengo con sube de mirarlo continuamente esto vale entonces al final yo el de abajo me está pintando el en la columna azul esta casilla de aquí vez esta casilla que está como más marcada se ve no sea si os fijáis yo entiendo que porque esto tiene una resolución bastante buena donde está el lápiz de verdad el lápiz este y yo nos vamos a hacer amigos nunca a ver lo pinto en amarillo y lo marco aquí es esto que la cosa menos pesada pensada salen cosas interesantes no es ahí eso esa eso es el el beat y ese es lo que se va moviendo y eso que no se mueve aquí porque porque tres estes son bueno pero esa esa era la que pinta cada uno vale esa es la que pinta cada uno de acuerdo eso es lo que cada uno va pintando entonces el problema es que yo si pongo el sistema aquí el que sea yo pongo un sistema aquí el cuando compre cuando compre sí que va a reflejar la realidad porque yo compro imagina que tiro a mercado contra las pero cuando venda va a seguir vendiendo contra las y realmente vende contra el beat pero el sistema que va a correr en este gráfico el sistema que va a correr en este gráfico algo que ejecute mucho ahora vale yo compro venda aquí he comprado vale y me dice que he comprado a unos 7 8 1 9 y ese precio probablemente ha sido real porque como es el rojo he comprado en este precio pero este me dice que ha vendido a 1 7 7 5 6 y no es verdad ha vendido más abajo ha vendido 45 ticks por debajo no es verdad ese precio entonces es un problema ya no tanto desde la deslizamiento que lo puedo simular sino que habrá veces que sea el mínimo o el máximo y marque ejecutado cuando realmente no ha ejecutado tienes la idea sea el problema es más de réplica eso a nosotros nos ha pasado mucho este ya lo contado porque al subir los tipos de interés en los futuros ha subido mucho ese spread esa diferencia entre entre el futuro y el cfd porque el cfd el tipo de interés lo tiene fuera o tienen su app en cambio el futuro lo tiene implícito pero ahora es otro tema pero el problema ha sido el mismo vale de que la compra va si yo ejecuto en este gráfico el sistema la compra se hace correcta la venta no y en este es lo contrario la compra no se hace correcta la venta así entonces bueno puedo jugar un poco con eso porque yo como puedo consultar el de abajo cuando calcula un precio de venta estaba para aurel y lo calculo en el de abajo cuando calcula un precio de compro lo calculo en el de arriba y con eso puedes tirar un poco y luego aparte también evidentemente con solucionarlo pero el problema en el histórico tiempo real es simular que realmente ejecutó lo que tocaba y ese problema en el vídeo las que hay es spread que a veces ejecutas por poco cuando ejecutas por poco no puede ser verdad pero puede ser que no vale bueno tenía ya para acabar del sistema este lo que lo que os comenté el tema de los cortos vale el tema de los cortos a nivel global es muy complicado lógicamente si lo miras a nivel de algunas acciones lo vas a encontrar y no es difícil no es difícil pero al uso tendencial no vale lo máximo que encontraríamos es es a ver dónde estoy yo que no he perdido pues ves aquí por ejemplo antes la fíjate es la entonces la creo que hasta va a ir directamente tendencia de todo parece lo parece pero no porque claro tiene un momento está configurado pero aquí que iría más bien pues seguramente entradas y ya digo atrás de rotura en un canal a lo mejor que no sea muy lejano no tráiler es bastante arriesgado ir a salida puede por tiempo no sé tres cuatro barras es lo que tenemos y luego recuerden que para comprar en debilidad y vender en fortaleza entonces en este caso fíjense en este punto hay una debilidad por buscar a buscar explosiones a lo que pasa es que te va a meter más grande también pero es muy difícil recuerden que el 90% de los traidores es una entrada muy lenta es una entrada muy lenta el don chan y cuando te pilla las buenas no lo vas a dejar correr sabes pero la verdad es complicado te va a tragar muchas malas en ese tipo de entradas es mejor ir a expansión de volatilidad cuando detectes alguna expansión de volatilidad entrar y cierro una posición cuál es la mayor ganancia cuál es cuál es la probabilidad de éxito que tiene más probabilidad de éxito en acciones de small caps ir en largo a ver la disponibilidad de acción que va a repercutir en nuestra operativa al revés esto muy que son las comisiones que pagamos aquí al revés la primera que vamos a analizar es cómo abro yo una posición estando en largo yo abro una posición están comprando y como yo abro una posición estando en corto vendiendo es decir ninguna posición abierta pero quiero abrir una posición en largo y quiero una posición en corto pero tengo que hacer en mtsl es muy complicado comprar corto de manera que cuando compro mil acciones mi posición va a ser pero bueno ya digo en algunas acciones es muy difícil entrando con don chan porque es una entrada el principal problema de esta entrada es que es muy retrasada y si la vamos a probar el extremo perdiendo el mínimo del día anterior a un día para el loco esto ya es loco el press down sea el low es el high vamos allá por todas y si va muy bien fantástico seguramente a una ahora que acercarlo más el tp no y que he hecho me equivocado pero 40 no 004 muy complicado corto tengo que volver de manera que mi posición va a ser ahora menos química y así de esta manera es como yo ya probaremos alguno tipo apolo en acciones a ver qué tal a ver si nos sale que sé que por ahí pediendo apolo ya veremos algo tipo apolo lo probaremos en acción es apolo en el lado corto en el nasdaq funciona aunque por ejemplo este año la cosa mucho esta es la parte 2 de la terminología esto es porque es muy importante a la hora de hacer trading porque acabamos de ver cuál es el lenguaje que utilizan los traders y sobre todo vamos a ver y vamos a entender en las estrategias estos son todos los términos que vamos a ver parecen muchísimos y parece muy abrumador esto pero la verdad cuando vean lo sencillo que es y lo simple no les haría de preocupar esto es para que seguimos de todas las cosas que vamos a ver en este módulo sobre dice que es decir lo primero vamos a ver un concepto que es de watchlist cuando escuchen decir a coño don chan claro claro no no don chan si nada es la hora es la hora me dijeron sobre don chan con stop y te ve y te y te ve igual que eso es un buen truco para medir un edge vale pero es verdad que para los tendenciales cuidado pero sí que es un buen es un buen es un buen truco rápido para ver casi ninguna te pasaba del 50 claro y si calculado con atr una unidad por cinco días si el truco es bueno pero es para evaluar la entrada de manera rápida pero es verdad que los tendenciales lo que te digo tienen que correr entonces a veces a lo mejor te puedes probar a darle 2 a 1 me sabes dejarle así y de eso bueno que ya lo veremos en una clase quiero hacer una clase que tengo que porque la tengo más o menos las clases pensadas y planeadas pero no el orden pensé sobre la marcha no como pide la clase pero como van las preguntas y demás pero sí que hay una que haremos búsqueda de patrones y uno de ellos por supuesto es ese y hay otro que es con la rotura del máximo del día anterior y cerrar al cierre por ejemplo y esto va bien para ver la tendencia de ese activo sabes para ver si las roturas de un día marcan tendencia o no y también lo puedes hacer en intradía para ver si en el intradía y tendencia puedes tener fails pero pero pero al final te dices en intradía tiene tendencia yo si rompe el máximo de ayer entro largo y al cierre ciego con eso mira si el activo de la día tiene tendencia nos salen todas pero muchas acciones de muchos activos te sale veremos cositas de estas un día que haremos con un código lo haremos varias de ellas y nos iremos pasando en distintos activos de acciones futuros de distinto tipo para para veáis distintas maneras de encontrar entradas vale que ya dijimos que veríamos bastantes querido empezar por el doncha porque sé que ha hablado mucho de él en el curso y además es bueno de verdad lo que pasa que tiene sus puntos débiles de sus puntos débiles y que donde va mejor el doncha de salir o sea es lo mismo que has visto en el lado largo que lo podéis explorar en vez de trailing en rotura no lo hemos hecho tal pero cuando os lo he dicho esto mismo igual pero yo lo dejo ahora bueno da igual porque está bloqueado para cortos pero voy a activar esto que me da igual no me importa mucho voy a dejar original a cero vamos a pasar ahora en cuanto rompa es algo así y aquí me salgo en 10 días habría que habría que ver habría que verle que rango le en que rango le metes pero bueno habría que verlo habría que verlo pero lo mismo buscar la explosión y salir de buscar la explosión y salir de esto y hasta 20 es demasiado podría ser mejor para 10 pero bueno ya digo es poco sensible canal como hemos visto es poco sensible con chan en general esto lo puedes probar las 10 acciones es decir en vez de ir al training o incluso dejando el trailing incluso dejando el trailing hasta suponiendo pocos cambios de la versión actual es decir no mira no no liar vale dejanse entre el link vale como lo tenías que era más o menos vamos a hacerlo subiendo lo mismo que tenías no vamos a dejar 20 igual 0 20 va 0 20 con 20 vale pero a mí es al mismo tiempo lo que se ha dicho le pruebas a la mente le dejas la media puesta ya verás que el trailing nos va a actuar casi nunca bueno le he dejado el time perdón le he dejado el time se lo puede dejar pero ahora por probar lo que quiero bueno va a salir algunas veces por tele algunas veces por media y así lo con más que la media se le va a pegar mucho se le va a pegar mucho y esta es otra variante que es un poquito más más rápida y que en muchos actores va a ir muy muy bien pero muy bien también es de dejar correr pero dejar correr menos luego ya lo que os decía decir en vez de esto a días esta es la que en muchos roturas se usa eso y ya está incluso mejor el tiempo es un poquito más más cerrado y os va a salir en muchos veces en tiempo no va a salir esto va a salir en tiempo y se pueden hacer varias variantes que ya no sean el propiamente tendencial y que va a ir en muchas alguna mejor no irá también pero va a ir para el muy bien en muchas porque porque al final sale el mercado antes tienen distintas maneras para salir eso sale por tiempo que sí que algunas veces pues saldrá mal pero pero mucho saldrá bien incluso en vida que ya veréis aquí no va a ser tan aquí por ejemplo seguramente irá típico pero también en las caídas veis pues como se salen 10 días pues al final se sale antes a lo mejor que con él con el don chan pero claro las subidas tendidas se va saliendo se va metiendo se va saliendo se va metiendo pero esta es una variante esto no te va a dar ratios tan tendenciales pero también te va a dar ratios tendenciales este 46 te va a dar 30 y pico como antes no lo hemos mirado antes en maestro pero esto debía dar esto debía dar 30 es 40 47 pues mira un da más de lo que pensaba prácticamente da más de lo que pensaba pensaba que daría menos pensaba que daría menos y el porcentaje de aciertos con este set up 44 46 46 47 dependiendo del set 44 47 pensaba que daría más de verdad se parece mucho bueno prácticamente el mismo bueno en vida seguramente daba más en ese este es seguramente envidia era de las que más porcentaje daba de acierto digo yo habíamos visto gráfico antes era espectacularmente tendencial claro una locura envidia estará por aquí a nos ha ordenado esto por alfabético no porque es ordenado no sé porque se ha ordenado bueno pues no sé da igual habrá de aquí con porcentaje de acierto es muy alto y habrá con menos esto ya os digo aquí es aquí aquí lo veis 40 a 47 50 33 100 pero muy poco es decir al final habrá un poco de todo pero las que han tirado más como envidia todo esto pues seguro que tiene un porcentaje altísimo lo que no sé ahora porque no la veo es que hay 100 no es fácil encontrarla no no sé por qué no lo tiene ordenado como estaba aquí esa microsoft es igual seguro seguro seguro que tiene un porcentaje de acierto bajo el cambio google carlos 55 55 quiere decir que aquí google igual en esto va mejor en esta en estas etapas y más más tendido para momentos que sí momentos que no muy justita aquí si aureli comenta perdón para realizar los rangos de parámetros pregunta fran es es buen sistema usar que el clínic si lo hacemos no sesgamos la zona paramétrica ahora mismo me pillas cuando me acuerdo que era que el minuto lo he leído es aquel que bajan por el lado suelo por el otro darte más explicación que la que te he dado ahora me voy a me voy a liar no sé no sé no sé decirte nada nada más en concreto comenta aureli lo de las tortugas pero miro me lo miro para el próximo día y te lo respondo calmo porque lo he leído pero no me acuerdo mismo el detalle exacto concreto aureli pregunta las tortugas de las tortugas son exactamente un don chan aureli es exactamente es exactamente lo que pasa que es un don chan que lo hacía si no recuerdo mal eran semanal tengo un libro por ahí de hecho y sí que era básicamente eso la clave una de las claves de las tortugas era la gestión monetaria que no no se ha propagado eso no se ha propagado totalmente eso pero pero tenían una gestión monetaria muy estricta y era era lo que iban promediando a favor era una manera de su de fallaron muchísimo después de ciertos megabajos es decir se iban un poco a buscar las envidias entonces la cuando pillaban una envidia la añadían añadían añadían se iban apalancándose en ella y claro los revientas es que los revientas es verdad son acciones es así o sea tú pillas la que lo revienta y es tremendo y se basaban un poco un poco en eso se basan un poco en eso vale pero esta franze quieres ponla si quieres en el discord lo que me has puesto si no te importa más que nada porque así te la me queda me queda archivada vale me queda archivada que vas a una preguntita más por ahí para cerrar dejó el sistema este ya por cerrado ya os he dejado si si alguien quiere el es que le puse como más cosas un poco para probando distintas que ya lo hicimos el primer día y ahora mismo pues un poco pero realmente por eso se ha dado el pdf de solo la versión esta porque es un poco la que hemos visto más a fondo y hemos trabajado un poco un poco más pero franze para ti que el mismo es el algoritmo que usa el poder en la esta de acciones aberto que no conecta mercado como se llama a mi no es no no no no no no no no no era la que usa la que usa es la que usa de todas maneras hay bastante yo es como aprovecho porque el enjambre de partículas también hay gente que al final yo no he leído nada ni visto nada súper concluyente que que mejor el algoritmo genético de verdad es que es es que al final y no no creo honestamente si hay algún paper por ahí que se me ha escapado pues pásame lo que lo leeré atentamente pero pero no creo de verdad que incluso ya por mi sentido común de mi experiencia que realmente haya un algoritmo que mejore mucho es la lógica que tiene algoritmo genético la misma que tiene partículas y seguramente es al final bien son lógicas de búsqueda de de búsqueda de zonas robustas que que al final todos siguen un poco lo mismo y a mí la de algoritmo genético también me parece muy razonable muy lógica y fomenta totalmente eso bueno siempre hay algo que sale que es mejor en teoría que no sé qué pero realmente es una gran mejor a eso pues a mí no me lo ha parecido las veces que yo he leído sobre otros algoritmos de búsqueda que es de lo que hablamos un poco se llamen perico que ya bueno y has visto toda la teoría ya ya me conoces el tema de los nombres que son muy poco amigos porque como no tengo memoria no me acuerdo de las cosas pues al final le el nombre a todo y y lo que importa son más las ideas entonces el el tema el algoritmo de búsqueda no creo yo que esté ahí la gran cosa no creo la verdad que no pero bueno ya digo al final evidentemente que se ha abierto que estar muy abierto siempre es muy importante a cualquier cosa nueva tal pero no es lo que es muy antiguo pero prefiero que cualquier cosa que sale ser atento a posibles mejoras no pero pero ya digo muchas al final acaban siendo poco de lo mismo da una vuelta de otra manera mejor más rápido o lo que fuera pero es un poco y no acaban de provocar unas grandes mejoras porque siempre hay gente pues más de pensura de una cosa y de la otra y esto pasa mucho lo buscaré si tienes alguna fuente por ahí me la pasas y la la miraré con calma y a ver qué da pero aunque estoy 100 por ciento seguro que leído sobre tanto sobre el hambre como el rey pero pero vaya hace tiempo y no recuerdo que me quedara la conclusión de que fuera algo mejor ni nada pues voy a ir cortando amigos si no hay más preguntas hasta el lunes que viene recordar que los jueves hacemos directo recordar que los jueves hacemos directo a quien se quiera pasar para poner alguna preguntita y también también puede también puede de acuerdo la clase se procesa el vídeo y en un ratito la tenéis ya subida de acuerdo nada más la semana que viene bueno vamos a poner el discord de que te crearemos la semana que viene porque tengo que mirar las las notas y decidiré pero mi idea era empezar ahora hemos hecho uno de la parte podemos decir acciones diarios semanal recordar no que hablamos un perfil más de medio largo plazo y ahora pues quería probar otro un poco más más de intradía así que tengo varios ya no no no no lo seguro pero puede que que hagamos el rb o puede que hagamos el rb que tenía pensado hacer intradiliario probablemente con el dax empecemos y veremos lo extrapolamos a más activos vale pero bueno ya no me lo toméis seguro seguro pero pero ese es uno de los que tengo anotados para para hacer uno de revés sobre el dax me gusta mucho un futuro que me gusta mucho vale eso sería intradía así que puede que vayamos con él el próximo día y en todo caso casi con toda seguridad que haremos algo intradía para para entrar un poquito más en cosas de más datos y más poquito más complejas que éstas vale amigos nada más os veo el lunes que viene recordar enviar dudas al discord porque así las podemos compartir entre todos y creo que eso pues añade tenerse aquí la sección de pregunta aquí para añadirlas y tratamos de responderlas tratamos de responderlas bueno algunas aquí y otras en la clase en directo porque creo que aportan a todos vale si alguien todavía no tiene acceso enviarnos un email con el vuestro usuario y os lo os lo daremos nada más amigos hasta pronto que tengáis muy buena semana